...
$reservoirs = array(
    ...
    // https://www.usbr.gov/gp/lakes_reservoirs/montana_lakes.html
    // http://dnrc.mt.gov/divisions/water/projects
    // http://www.nwd.usace.army.mil/Media/Fact-Sheets/Fact-Sheet-Article-View/Article/621048/libby-dam/
    "Ackley Lake" => array("station_id" => "06110500", "capacity" => 6722, "state" => "MT"),
    "Ashley Lake" => array("station_id" => "12367000", "capacity" => 20400, "state" => "MT"),
    "Bair" => array("station_id" => "06116500", "capacity" => 7300, "state" => "MT"),
 //   "Beaver Creek" => array("station_id" => "06140300", "capacity" => , "state" => "MT"),
    "Bighorn Lake" => array("station_id" => "06286400", "capacity" => 1381189, "state" => "MT"),
 //   "Camas" => array("station_id" => "12375600", "capacity" => , "state" => "MT"),
    "Canyon Ferry Lake" => array("station_id" => "06058500", "capacity" => 2051000, "state" => "MT"),
    "Clark Canyon" => array("station_id" => "06015300", "capacity" => 325324, "state" => "MT"),
    "Cooney" => array("station_id" => "06212000", "capacity" => 28230, "state" => "MT"),
    "Deadman's Basin" => array("station_id" => "06122500", "capacity" => 72218, "state" => "MT"),
    "East Fork Rock Creek" => array("station_id" => "12332500", "capacity" => 16040, "state" => "MT"),
    "Ennis Lake" => array("station_id" => "06040500", "capacity" => 42053, "state" => "MT"),
   // "Flathead Lake" => array("station_id" => "12371550", "capacity" => , "state" => "MT"),
    "Fort Peck Lake" => array("station_id" => "06131500", "capacity" => 18700000, "state" => "MT"),
   // "Four Horns Lake" => array("station_id" => "06093000", "capacity" => , "state" => "MT"),
    "Fresno" => array("station_id" => "06136500", "capacity" => 127200, "state" => "MT"),
  //  "Georgetown Lake" => array("station_id" => "12325000", "capacity" => , "state" => "MT"),
    "Gibson" => array("station_id" => "06079500", "capacity" => 99100, "state" => "MT"),
    "Hauser Lake & Lake Helena" => array("station_id" => "06065100", "capacity" => 98000, "state" => "MT"),
    "Hebgen Lake" => array("station_id" => "06038000", "capacity" => 386181, "state" => "MT"),
  //  "Helena Valley" => array("station_id" => "06058600", "capacity" => , "state" => "MT"),
    "Holter Lake" => array("station_id" => "06066000", "capacity" => 243000, "state" => "MT"),
  //  "Hungry Horse Lake" => array("station_id" => "12362000", "capacity" => , "state" => "MT"),
  //  "Lake Como" => array("station_id" => "12344500", "capacity" => , "state" => "MT"),
    "Lake Elwell (Tiber)" => array("station_id" => "06101300", "capacity" => 1555898, "state" => "MT"),
   // "Lake Frances" => array("station_id" => "06095500", "capacity" => , "state" => "MT"),
   // "Lake Helena" => array("station_id" => "06064500", "capacity" => , "state" => "MT"),
    "Lake Koocanusa" => array("station_id" => "12301920", "capacity" => 4979500, "state" => "MT"),
    "Lake Sherburne" => array("station_id" => "05015500", "capacity" => 68080, "state" => "MT"),
    "Lima" => array("station_id" => "06012000", "capacity" => 84003, "state" => "MT"),
   // "Lower Jocko Lake" => array("station_id" => "12380500", "capacity" => , "state" => "MT"),
    "Lower Two Medicine Lake" => array("station_id" => "06090900", "capacity" => 25120, "state" => "MT"),
   // "Lower Willow Creek" => array("station_id" => "12330800", "capacity" => , "state" => "MT"),
    "Martinsdale" => array("station_id" => "06119000", "capacity" => 23348, "state" => "MT"),
    "Middle Creek" => array("station_id" => "06049500", "capacity" =>  10184, "state" => "MT"),
 //   "Mission Valley" => array("station_id" => "12380100", "capacity" => , "state" => "MT"),
  //  "Mystic Lake" => array("station_id" => "06204000", "capacity" => , "state" => "MT"),
    "Nelson" => array("station_id" => "06155000", "capacity" => 79200, "state" => "MT"),
    "Nevada Creek" => array("station_id" => "12336500", "capacity" => 11152, "state" => "MT"),
 //   "Newlan Lake" => array("station_id" => "06763100", "capacity" => , "state" => "MT"),
    "Nilan" => array("station_id" => "06083000", "capacity" => 10092, "state" => "MT"),
    "Noxon Rapids" => array("station_id" => "12391300", "capacity" => 400000, "state" => "MT"),
    "Painted Rocks Lake" => array("station_id" => "12342000", "capacity" => 32362, "state" => "MT"),
    "Pishkun" => array("station_id" => "06080500", "capacity" => 46700, "state" => "MT"),
    "Ruby River" => array("station_id" => "06020500", "capacity" => 37642, "state" => "MT"),
